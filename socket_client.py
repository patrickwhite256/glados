...
parser.add_argument('--plugin',
                    dest='plugin_name',
                    help='Plugin to send the data to',
                    required=True
                    )
parser.add_argument('--data',
                    dest='data',
                    help='Data to send to the plugin. If not provided will accept from stdin.'
                    )
...
message_contents = '{}:{}{}'.format(len(args.plugin_name), args.plugin_name, message_data)
